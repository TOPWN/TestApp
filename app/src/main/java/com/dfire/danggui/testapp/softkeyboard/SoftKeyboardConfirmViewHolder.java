...
public class SoftKeyboardConfirmViewHolder extends KeyboardBaseRecyclerHolder<KeyboardModel> implements Divided {
    @Bind(R.id.btn_keys)
    TextView mBtnKeys;
    private KeyboardModel mKeyboardModel;

    public SoftKeyboardConfirmViewHolder(Context context, View itemView, RecyclerView.Adapter adapter) {
