package com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders;
 ...
 *
 * @see com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.SectioningAdapter
 */
...
public class StickyHeaderLayoutManager extends RecyclerView.LayoutManager {
	...
	private static final String TAG = com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.StickyHeaderLayoutManager.class.getSimpleName();

	private com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.SectioningAdapter adapter;
	...
	public void onAdapterChanged(RecyclerView.Adapter oldAdapter, RecyclerView.Adapter newAdapter) {
		...
		try {
			adapter = (com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.SectioningAdapter) newAdapter;
	...
	public void onAttachedToWindow(RecyclerView view) {
		...
		try {
			adapter = (com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.SectioningAdapter) view.getAdapter();
		} catch (ClassCastException e) {
			throw new ClassCastException("StickyHeaderLayoutManager must be used with a RecyclerView where the adapter is a kind of SectioningAdapter");
		}
	}
	...
	public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
		...
		for (int adapterPosition = firstViewAdapterPosition; adapterPosition < state.getItemCount(); adapterPosition++) {
			...
			if (itemViewType == com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.SectioningAdapter.TYPE_HEADER) {
				headerViews.add(v);
			...
			} else if (itemViewType == com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.SectioningAdapter.TYPE_GHOST_HEADER) {
	...
	private View createSectionHeaderIfNeeded(RecyclerView.Recycler recycler, int sectionIndex) {
		...
		if (adapter.doesSectionHaveHeader(sectionIndex)) {
			...
			for (int i = 0, n = getChildCount(); i < n; i++) {
				...
				if (getViewBaseType(view) == com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.SectioningAdapter.TYPE_HEADER && getViewSectionIndex(view) == sectionIndex) {
					return view;
				}
			}
		...
		if (dy < 0) {
			...
			while (scrolled > dy) {
				...
				if (firstViewAdapterPosition > 0 && scrolled > dy) {
					...
					boolean isHeader = itemViewType == com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.SectioningAdapter.TYPE_HEADER;
					...
					if (isHeader) {
						...
						isHeader = itemViewType == com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.SectioningAdapter.TYPE_HEADER;
					...
					int top;
					boolean isGhostHeader = itemViewType == com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.SectioningAdapter.TYPE_GHOST_HEADER;
					if (isGhostHeader) {
	 ...
	 */
	@Nullable
	public com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.SectioningAdapter.ItemViewHolder getFirstVisibleItemViewHolder(boolean fullyVisibleOnly) {
		return (com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.SectioningAdapter.ItemViewHolder) getFirstVisibleViewHolderOfType(com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.SectioningAdapter.TYPE_ITEM, fullyVisibleOnly);
	}
	 ...
	 */
	@Nullable
	public com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.SectioningAdapter.HeaderViewHolder getFirstVisibleHeaderViewHolder(boolean fullyVisibleOnly) {
		return (com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.SectioningAdapter.HeaderViewHolder) getFirstVisibleViewHolderOfType(com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.SectioningAdapter.TYPE_HEADER, fullyVisibleOnly);
	}
	 ...
	 */
	@Nullable
	public com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.SectioningAdapter.FooterViewHolder getFirstVisibleFooterViewHolder(boolean fullyVisibleOnly) {
		return (com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.SectioningAdapter.FooterViewHolder) getFirstVisibleViewHolderOfType(com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.SectioningAdapter.TYPE_FOOTER, fullyVisibleOnly);
	}

	@Nullable
	private com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.SectioningAdapter.ViewHolder getFirstVisibleViewHolderOfType(int baseType, boolean fullyVisibleOnly) {
		if (getChildCount() == 0) {
			return null;
		}
		...
		if (baseType != com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.SectioningAdapter.TYPE_HEADER) {
			com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.SectioningAdapter.HeaderViewHolder firstHeader = getFirstVisibleHeaderViewHolder(false);
			if (firstHeader != null) {
	...
	private void recycleViewsOutOfBounds(RecyclerView.Recycler recycler) {
		...
		for (int i = 0; i < numChildren; i++) {
			...
			if (getViewBaseType(view) != com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.SectioningAdapter.TYPE_HEADER) {
		...
		for (int i = 0; i < numChildren; i++) {
			...
			if (getViewBaseType(view) == com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.SectioningAdapter.TYPE_HEADER && !remainingSections.contains(sectionIndex)) {
	...
	private View getTopmostChildView() {
		...
		for (int i = 0, e = getChildCount(); i < e; i++) {
			...
			// ignore headers
			if (getViewBaseType(v) == com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.SectioningAdapter.TYPE_HEADER) {
				continue;
			}
	...
	private void updateHeaderPositions(RecyclerView.Recycler recycler) {
		...
		for (View headerView : headerViews) {
			...
			for (int i = 0, n = getChildCount(); i < n; i++) {
				...
				if (type == com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.SectioningAdapter.TYPE_HEADER) {
					continue;
				}

				int viewSectionIndex = getViewSectionIndex(view);
				if (viewSectionIndex == sectionIndex) {
					if (type == com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.SectioningAdapter.TYPE_GHOST_HEADER) {
						ghostHeader = view;
					}
	...
	private com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.SectioningAdapter.ViewHolder getViewViewHolder(View view) {
	...
	private class SmoothScroller extends LinearSmoothScroller {
		...
		public PointF computeScrollVectorForPosition(int targetPosition) {
			return new PointF(0, com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.StickyHeaderLayoutManager.this.computeScrollVectorForPosition(targetPosition));
		}
	...
	private static class SavedState implements Parcelable {
		...
		public static final Creator<SavedState> CREATOR = new Creator<com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.StickyHeaderLayoutManager.SavedState>() {
			@Override
			public com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.StickyHeaderLayoutManager.SavedState createFromParcel(Parcel in) {
				return new com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.StickyHeaderLayoutManager.SavedState(in);
			}

			@Override
			public com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.StickyHeaderLayoutManager.SavedState[] newArray(int size) {
				return new com.dfire.danggui.testapp.stickyrecyclerview.stickyrecyclerviewheaders.StickyHeaderLayoutManager.SavedState[size];
			}
		};
	}
}
