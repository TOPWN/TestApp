...
public class DIProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        for (Element element : elements) {
            ...
            bindViewMethodSpecBuilder.addStatement("Class classname = $T.class"
                    , ClassName.get((TypeElement) element));
//            bindViewMethodSpecBuilder.addStatement("try { " +
//                    "java.lang.reflect.Constructor<?> constructor = classname.getDeclaredConstructor(); " +
